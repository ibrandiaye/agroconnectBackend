    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">Enregistrer une Bulletin de meteo</h4>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <div class="col-lg-8 offset-lg-2">
                                        <div class="p-5">
                                            ...
                                            <div class="form-group lg-12">
                                                <input type="text" class="form-control form-control-user" name="type" id="type"  placeholder="Entrer le type du publication..." required>
                                            </div>
                                            <div class="form-group lg-12">
                                                <input type="text" class="form-control form-control-user" name="zone" id="type"  placeholder="Entrer le zone conerné par bulletin de meteo..." required>
                                            </div>
                                            <div class="form-group lg-12">
